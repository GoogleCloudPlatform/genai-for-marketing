...
### In Cloud Shell, authenticate with your account and set Quota Project
...
### Clone the Gen AI for Marketing repository
...
From Cloud Shell, navigate to [/notebooks](/notebooks) and execute the following command.  
Make sure you have set the environmental variables PROJECT_ID and LOCATION.
> cd ./genai-for-marketing/notebooks

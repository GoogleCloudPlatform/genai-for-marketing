...
@Component({
  selector: 'app-website-post-edit-image',
  templateUrl: './website-post-edit-image.component.html',
  styleUrl: './website-post-edit-image.component.scss'
})
export class WebsitePostEditImageComponent implements AfterViewInit , OnChanges{
  ...
  constructor(public websitePostService: WebsitePostService, private domSanitizer: DomSanitizer,
  ) { }
  ngOnChanges() {
  ...
  buildMyCanvas() {
    ...
    this.ctx.lineWidth = 0.5; // Border width
  ...
  generate() {
    ...
    this.websitePostService.editImageWebsitePost(obj).subscribe((res: any) => {
      ...
      res.generated_images.forEach((element: { images_base64_string: string; id: any }) => {
        ...
        // this.promptGeneratedImages.push(this.emailCopy);

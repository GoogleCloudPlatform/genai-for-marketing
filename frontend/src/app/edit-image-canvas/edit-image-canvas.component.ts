...
@Component({
  selector: 'app-edit-image-canvas',
  templateUrl: './edit-image-canvas.component.html',
  styleUrl: './edit-image-canvas.component.scss'
})
export class EditImageCanvasComponent implements AfterViewInit, OnChanges {
